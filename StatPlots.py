...
for actype in types:
    for timeval in timesteps:
        ...
        for noise_type, threshold_val in zip(noise_columns, threshold_vals):
            ...
            print('hispanic in tracts:', high_noise_tracts['B03002012'].sum())
            print('hispanic in total: ', total_hispanic_population)

            print('diff:', high_noise_tracts['B03002012'].sum() /total_hispanic_population*100)

            print('black pop in tracts:', high_noise_tracts['B03002004'].sum())
            print('black pop in total: ', total_black_population)

            print('black pop:diff', high_noise_tracts['B03002004'].sum() /total_hispanic_population*100)
            ...
            population_groups = ['Total Hispanic Population Percentage', 'Hispanic Population Percentage in High Noise Tracts',
                                'Total Black Population Percentage', 'High Noise Tract Black Population in High Noise Tracts']
            ...
            bars = plt.barh(population_groups, percentages, color=colors)
